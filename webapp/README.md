...
- **Standalone backend** (accounts, PostgreSQL, REST API, Docker):
  ...
  `ghcr.io/cisotoolbox/ciso-audit:latest`.
...
| What | Where | Lifetime |
|------|-------|----------|
| Work in progress (autosave) | `localStorage["iso_audit_autosave"]` | Until you clear the browser storage |
| Snapshots | `localStorage["iso_audit_autosave_snapshots"]` (optionally AES-256-GCM encrypted) | Same |
