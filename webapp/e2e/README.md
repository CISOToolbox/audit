# End-to-end tests — ISO 27001 Audit

Playwright tests for the CISO Toolbox **ISO 27001 Audit** module. They run against a
...
Use another port if `8182` is taken:
...
| 7 | Local persistence | An audit created **by the test itself** through the metadata form autosaves to `localStorage` and is still there after a reload — no fixture file, no server |
